...
public class RegistrationRDemo extends AppCompatActivity implements RegistrationOnClickListener {
    ...
    public void onRegisterClick() {
        ...
        if (regForm.validateInputs()) {
            ...
            Toast.makeText(getBaseContext(), "User's name: " + user.getEmail() + " Marital Status " + user.getMaritalStatus(), Toast.LENGTH_LONG).show();
            //start login form A
            startActivity(new Intent(RegistrationRDemo.this, LoginFormAActivityDemo.class));
        }
    }
    ...
    public void onSignInClick() {
        ...
        //start login form B
        startActivity(new Intent(RegistrationRDemo.this, LoginFormBActivityDemo.class));
    }
}
